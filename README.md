...
| **Current**| 2023.04 ~ 2023.07 | Data Scientist Intern | **SK Planet** |
...
- [2023] IT서비스학회: **ERP 우수논문상** (명시적 및 암시적 피드백을 활용한 그래프 컨볼루션 네트워크 기반 추천 시스템 개발)
- [2022] 제 3회 대구 빅데이터 분석 경진대회: **최우수상** (자연어처리와 군집 분석을 활용한 최적의 심야 버스 정류장 선정 알고리즘 구축)
- [2022] 빅데이터 청년 캠퍼스: **장려상** (가치 투자 종목 추천 웹 서비스 구축)
